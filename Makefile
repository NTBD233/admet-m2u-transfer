...
second-paper-tables:
	$(PYTHON) build_second_paper_tables.py
...
selector-calibration-route-audit:
	$(PYTHON) analyze_selector_calibration_and_routes.py --datasets caco2_wang ppbr_az --train-ratio-tags 10 20 50 --seeds 42 123 3407 --output-root results_selector_calibration_route_audit
...
selector-utilization-sanity:
	$(PYTHON) train.py --datasets ppbr_az --models ECFP4_MLP_DescAdapterFusion --train-ratio-tags 20 --seeds 42 --teacher-root data/teacher_predictions --teacher-models ECFP4_RF Desc_RF ECFP4_Desc_RF --selector-root data/selector_predictions --selector-model-name rf_crossfit_train_pseudo_oracle --multiteacher-strategy pretrained_selector_top1 --selector-distill-reweight --selector-distill-reweight-mode global_confidence --lambda-distill 1.0 --results-root results_selector_utilization_sanity_ppbr_global
	$(PYTHON) train.py --datasets caco2_wang --models ECFP4_MLP_DescAdapterFusion --train-ratio-tags 10 --seeds 42 --teacher-root data/teacher_predictions --teacher-models ECFP4_RF Desc_RF ECFP4_Desc_RF --selector-root data/selector_predictions --selector-model-name rf_crossfit_train_pseudo_oracle --multiteacher-strategy pretrained_selector_top1 --selector-distill-reweight --selector-distill-reweight-mode disagreement_confidence --lambda-distill 1.0 --results-root results_selector_utilization_sanity_caco2_disagreement

selector-utilization-sanity-analysis:
	$(PYTHON) analyze_selector_failure_modes.py --dataset ppbr_az --train-ratio-tag 20 --seed 42 --selector-student-root results_selector_utilization_sanity_ppbr_global --top1-student-root results_multiteacher_top1 --output-root results_selector_utilization_sanity_analysis
	$(PYTHON) analyze_selector_failure_modes.py --dataset caco2_wang --train-ratio-tag 10 --seed 42 --selector-student-root results_selector_utilization_sanity_caco2_disagreement --top1-student-root results_multiteacher_top1 --output-root results_selector_utilization_sanity_analysis

validation-selected-reweight-partial-regression:
	$(PYTHON) train.py --datasets caco2_wang --models ECFP4_MLP_DescAdapterFusion --train-ratio-tags 10 20 50 --seeds 42 123 3407 --teacher-root data/teacher_predictions --teacher-models ECFP4_RF Desc_RF ECFP4_Desc_RF --selector-root data/selector_predictions --selector-model-name rf_crossfit_train_pseudo_oracle --multiteacher-strategy pretrained_selector_top1 --selector-distill-reweight --selector-distill-reweight-mode global_confidence --lambda-distill 1.0 --results-root results_pretrained_selector_top1_reweight_caco2_regression --skip-existing
	$(PYTHON) train.py --datasets caco2_wang --models ECFP4_MLP_DescAdapterFusion --train-ratio-tags 10 20 50 --seeds 42 123 3407 --teacher-root data/teacher_predictions --teacher-models ECFP4_RF Desc_RF ECFP4_Desc_RF --selector-root data/selector_predictions --selector-model-name rf_crossfit_train_pseudo_oracle --multiteacher-strategy pretrained_selector_top1 --selector-distill-reweight --selector-distill-reweight-mode disagreement_confidence --lambda-distill 1.0 --results-root results_pretrained_selector_top1_disagreement_reweight_caco2_regression --skip-existing
	$(PYTHON) train.py --datasets ppbr_az --models ECFP4_MLP_DescAdapterFusion --train-ratio-tags 10 20 50 --seeds 42 123 3407 --teacher-root data/teacher_predictions --teacher-models ECFP4_RF Desc_RF ECFP4_Desc_RF --selector-root data/selector_predictions --selector-model-name rf_crossfit_train_pseudo_oracle --multiteacher-strategy pretrained_selector_top1 --selector-distill-reweight --selector-distill-reweight-mode global_confidence --lambda-distill 1.0 --results-root results_pretrained_selector_top1_reweight_ppbr_regression --skip-existing
	$(PYTHON) train.py --datasets ppbr_az --models ECFP4_MLP_DescAdapterFusion --train-ratio-tags 10 20 50 --seeds 42 123 3407 --teacher-root data/teacher_predictions --teacher-models ECFP4_RF Desc_RF ECFP4_Desc_RF --selector-root data/selector_predictions --selector-model-name rf_crossfit_train_pseudo_oracle --multiteacher-strategy pretrained_selector_top1 --selector-distill-reweight --selector-distill-reweight-mode disagreement_confidence --lambda-distill 1.0 --results-root results_pretrained_selector_top1_disagreement_reweight_ppbr_regression --skip-existing

validation-selected-reweight-summary:
	$(PYTHON) compare_validation_selected_reweight.py

pretrained-selector-top1-ratio-lambda-smoke:
	$(PYTHON) train.py --datasets caco2_wang --models ECFP4_MLP_DescAdapterFusion --train-ratio-tags 50 --seeds 42 --teacher-root data/teacher_predictions --teacher-models ECFP4_RF Desc_RF ECFP4_Desc_RF --selector-root data/selector_predictions --selector-model-name rf_crossfit_train_pseudo_oracle --multiteacher-strategy pretrained_selector_top1 --lambda-distill 1.0 --lambda-distill-ratio-schedule low_resource_decay --results-root results_pretrained_selector_top1_ratio_lambda_smoke

pretrained-selector-top1-ratio-lambda-ppbr50-smoke:
	$(PYTHON) train.py --datasets ppbr_az --models ECFP4_MLP_DescAdapterFusion --train-ratio-tags 50 --seeds 42 --teacher-root data/teacher_predictions --teacher-models ECFP4_RF Desc_RF ECFP4_Desc_RF --selector-root data/selector_predictions --selector-model-name rf_crossfit_train_pseudo_oracle --multiteacher-strategy pretrained_selector_top1 --lambda-distill 1.0 --lambda-distill-ratio-schedule low_resource_decay --results-root results_pretrained_selector_top1_ratio_lambda_ppbr50_smoke

pretrained-selector-top1-ratio-lambda-partial-regression:
	$(PYTHON) train.py --datasets caco2_wang ppbr_az --models ECFP4_MLP_DescAdapterFusion --train-ratio-tags 10 20 50 --seeds 42 123 3407 --teacher-root data/teacher_predictions --teacher-models ECFP4_RF Desc_RF ECFP4_Desc_RF --selector-root data/selector_predictions --selector-model-name rf_crossfit_train_pseudo_oracle --multiteacher-strategy pretrained_selector_top1 --lambda-distill 1.0 --lambda-distill-ratio-schedule low_resource_decay --results-root results_pretrained_selector_top1_ratio_lambda_partial_regression --skip-existing

pretrained-selector-top1-high-resource-lambda-partial-regression:
	$(PYTHON) train.py --datasets caco2_wang ppbr_az --models ECFP4_MLP_DescAdapterFusion --train-ratio-tags 10 20 50 --seeds 42 123 3407 --teacher-root data/teacher_predictions --teacher-models ECFP4_RF Desc_RF ECFP4_Desc_RF --selector-root data/selector_predictions --selector-model-name rf_crossfit_train_pseudo_oracle --multiteacher-strategy pretrained_selector_top1 --lambda-distill 1.0 --lambda-distill-ratio-schedule high_resource_decay --results-root results_pretrained_selector_top1_high_resource_lambda_partial_regression --skip-existing

pretrained-selector-top1-high-resource-lambda-regression:
	$(PYTHON) train.py --datasets caco2_wang lipophilicity_astrazeneca solubility_aqsoldb vdss_lombardo ppbr_az --models ECFP4_MLP_DescAdapterFusion --train-ratio-tags 10 20 50 --seeds 42 123 3407 --teacher-root data/teacher_predictions --teacher-models ECFP4_RF Desc_RF ECFP4_Desc_RF --selector-root data/selector_predictions --selector-model-name rf_crossfit_train_pseudo_oracle --multiteacher-strategy pretrained_selector_top1 --lambda-distill 1.0 --lambda-distill-ratio-schedule high_resource_decay --results-root results_pretrained_selector_top1_high_resource_lambda_regression --skip-existing
...
selector-calibration-full-comparison:
	$(PYTHON) compare_selector_calibration.py --methods base=results fixed_ecfp_desc=results_distill_regression top1_validation=results_multiteacher_top1 plain_selector=results_pretrained_selector_top1_regression high_decay=results_pretrained_selector_top1_high_resource_lambda_regression --reference-methods base fixed_ecfp_desc top1_validation plain_selector --datasets caco2_wang lipophilicity_astrazeneca solubility_aqsoldb vdss_lombardo ppbr_az --output-root results_pretrained_selector_top1_high_resource_lambda_regression/summary
